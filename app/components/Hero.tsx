...
function HeroSection() {
  return (
    <div className="w-full h-full md:h-[calc(100vh-250px)] my-10 sm:my-16 md:my-24 flex flex-col-reverse md:flex-row justify-center items-center">
        <div className="w-md md:w-xl lg:w-4xl mx-10 text-white">
            <h1 className="text-5xl md:text-7xl lg:text-[140px] font-black tracking-tighter leading-[0.8]">Arsh Ahmad</h1>
            <p className="mt-5 text-sm md:text-xl text-white/70 max-w-6xl">
            ...
            <div className="mt-5 w-2xl flex flex-col justify-start text-sm md:text-xl">
                <div>
                    <a href="#">
                        <button className="px-10 py-3 rounded-lg bg-[#dcfd00] text-black cursor-pointer hover:shadow-[0px_0px_20px_#dcfd00]">
                            <span className="font-bold ">Get in Touch</span>
                        </button>
                    </a>
                    <a href="#">
                        <button className="mx-5 px-10 py-3 outline-3 rounded-lg shadow-[4px_6px_0px_#000] cursor-pointer text-[#dcfd00] hover:border-none hover:bg-[#dcfd00] hover:text-black">
                ...
                <div className="mt-5 flex justify-start gap-5">
                    <a href="https://github.com/ARSH-AHMAD195" target="_blank">
                        <button className="w-15 h-15 flex justify-center items-center outline-3 rounded-full bg-black  cursor-pointer text-white hover:shadow-[0px_0px_20px_#ffffff]">
